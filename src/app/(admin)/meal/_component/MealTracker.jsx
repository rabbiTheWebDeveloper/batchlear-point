...
const MealTracker = ({ data: initialData, roommade }) => {
    ...
    if (selectedDay) {
      ...
      try {
        ...
        if (response.error) {
          ...
          updatedData[personIndex].meals[dayIndex] = {
            ...meal,
            count: mealCount,
            details: mealDetails,
          };
  ...
  const addUser = async () => {
    ...
    setIsLoading(true);
    try {
      const response = await mealTrackerInsertAction({
            ...
            <div className="mb-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <input
                  ...
                  value={mealCount}
                  onChange={(e) =>
                    setMealCount(Math.max(0, Number(e.target.value)))
                  }
