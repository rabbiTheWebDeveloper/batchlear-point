      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="flex items-center p-6 bg-white rounded-lg shadow-md">
          ...
          <div>
            ...
            <p className="text-gray-600 text-xl font-bold">120</p>
          </div>
        </div>
        ...
        <div className="flex items-center p-6 bg-white rounded-lg shadow-md">
          ...
          <div>
            ...
            <p className="text-gray-600 text-xl font-bold">$2,400</p>
          </div>
        </div>
        ...
        <div className="flex items-center p-6 bg-white rounded-lg shadow-md">
          ...
          <div>
            ...
            <p className="text-gray-600 text-xl font-bold">$1,800</p>
          </div>
        </div>
        ...
        <div className="flex items-center p-6 bg-white rounded-lg shadow-md">
          ...
          <div>
            ...
            <p className="text-gray-600 text-xl font-bold">$20/meal</p>
          </div>
        </div>
        ...
        <div className="flex items-center p-6 bg-white rounded-lg shadow-md">
          ...
          <div>
            ...
            <p className="text-gray-600 text-xl font-bold">$2,000</p>
          </div>
        </div>
        ...
        <div className="flex items-center p-6 bg-white rounded-lg shadow-md">
          ...
          <div>
            ...
            <p className="text-gray-600 text-xl font-bold">$400</p>
          </div>
        </div>
      </div>
    </div>
